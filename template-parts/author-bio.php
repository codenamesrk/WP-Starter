...
<?php if( is_author() ) :  ?>
	<section class="author-bio">
		<div class="medium-11 medium-centered large-9 columns medium-text-center">
			<h6>Author</h6>
			<h2>Mathew A Varghese</h2>
			<p class="author-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque quam commodi facilis nulla adipisci. Quidem facilis minus fugiat praesentium voluptates perferendis nesciunt sapiente, voluptas deserunt incidunt ducimus libero nemo natus.</p>
...
<?php elseif( !is_single() ) :  ?>
	<section class="author-bio">
		<div class="wps medium-9 medium-centered columns medium-text-center">			
