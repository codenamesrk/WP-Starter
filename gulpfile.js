...
gulp.task('copy', function() {
  // Font Awesome
  	...
  	var slick = gulp.src('assets/components/slick-carousel/slick/fonts/**/*.*')
  	.pipe(gulp.dest('assets/fonts/'));
  	var loadergif = gulp.src('assets/components/slick-carousel/slick/ajax-loader.gif')
  	.pipe(gulp.dest('assets/images/'));
  	return merge(fontAwesome,slick,loadergif);
  });
