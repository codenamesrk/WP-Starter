...
$ git clone https://github.com/codenamesrk/WP-Starter.git
$ cd WP-Starter
$ npm install
```
...
Please note that you **must** run `npm run build` or `npm run watch` in your terminal for the styles to be copied and concatenated. See the [Gulpfile.js](https://github.com/codenamesrk/WP-Starter/blob/master/gulpfile.js) for details
