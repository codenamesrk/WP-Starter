...
class Foundationpress_Comments extends Walker_Comment {
	...
	function __construct() { ?>
		...
		<h4 class="comments-number"><?php comments_number( __( 'No Responses to', 'foundationpress' ), __( 'One Response to', 'foundationpress' ), __( '% Responses to', 'foundationpress' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h4>
